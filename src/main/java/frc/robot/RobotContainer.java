...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new POVButton(m_gunner, 0).whileTrue(new SetArmAndElevatorPositions(m_elevator, m_arm, 0.71, 0.215));
    ...
    new JoystickButton(m_driver, XboxController.Button.kBack.value).onTrue(new SetArmAndElevatorPositions(m_elevator, m_arm, 0.0, 0.1));
