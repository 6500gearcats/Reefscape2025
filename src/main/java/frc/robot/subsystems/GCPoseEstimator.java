...
public class GCPoseEstimator extends SubsystemBase {
  ...
  // TODO: Add appropriate the standard deviation for the model's states and the
  // vision measurements.
  ...
  // * Uses Limelight
  public GCPoseEstimator(DriveSubsystem m_robotDrive, Supplier<Rotation2d> rotationSupplier,
  ...
  // * Uses PhotonVision
  public GCPoseEstimator(Supplier<Rotation2d> rotationSupplier,
      Supplier<SwerveModulePosition[]> swerveModulePositionSupplier) {
    m_rotationSupplier = rotationSupplier;
    m_swerveModulePositionSupplier = swerveModulePositionSupplier;
  ...
  public void useLimeLight() {
    // TODO: add logic to update useMegaTag2 dynamically based on what limelight
    // sees
  ...
  public void usePhotonVision() {
    ...
    // m_poseEstimator.addVisionMeasurement(est.estimatedPose.toPose2d(),
