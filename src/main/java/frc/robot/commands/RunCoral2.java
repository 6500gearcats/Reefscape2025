...
public class RunCoral2 extends ParallelDeadlineGroup {
  /** Creates a new RunCoralRight. */
  AprilTagFieldLayout field;
  DriveSubsystem m_drive;
  public RunCoral2(DriveSubsystem m_drive) {
    // Add the deadline command in the super() call. Add other commands usin
    super(new IsRobotAtPosition(m_drive));
    addCommands(AutoBuilder.pathfindToPose(getBestAprilTag2(m_drive), new PathConstraints(3.0, 3.0, Units.degreesToRadians(540), Units.degreesToRadians(720))));
  }

  private Pose2d getBestAprilTag2(DriveSubsystem m_drive) {
